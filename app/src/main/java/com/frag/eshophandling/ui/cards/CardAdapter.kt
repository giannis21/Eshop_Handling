package com.frag.eshophandling.ui.cards
...
import com.frag.eshophandling.databinding.ViewCardsBinding
import com.frag.eshophandling.databinding.ViewListBinding
    ...
    inner class ItemViewHolder(var viewCardsBinding: ViewCardsBinding) : RecyclerView.ViewHolder(viewCardsBinding.root){
        ...
        private inner class CustomEditTextListener(var holder: ItemViewHolder,var inputField: String) : TextWatcher {
            ...
            override fun afterTextChanged(s: Editable) {
                ...
                try {
                    if (inputField == "price")
                        products_list[holder.adapterPosition].price = text
                    else
                        products_list[holder.adapterPosition].quantity = text
                }catch (e: Exception){
